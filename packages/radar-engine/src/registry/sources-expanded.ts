...
const SOURCES: CompactSource[] = [
  ...
  directory('ArtConnect Opportunities', 'https://www.artconnect.com/opportunities?fees=FREE&sortBy=-deadline', 'grants-international', { disciplines: ['visual-arts', 'film', 'photography', 'design'], opportunityTypes: ['grant', 'residency', 'open-call'], geography: ['global'], checkIntervalHours: 24, discoveryAdapterId: 'artconnect-index', discoveryLinkLimit: 500 }),
