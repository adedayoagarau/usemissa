...
const SOURCES: CompactSource[] = [
  ...
  directory('African Culture Fund Calls', 'https://www.africanculturefund.net/en/call-for-projects-pages-acf/', 'bipoc-focused', { disciplines: ['all-disciplines'], opportunityTypes: ['grant', 'fellowship', 'open-call'], geography: ['Africa'], discoveryAdapterId: 'african-culture-fund-index' }),
