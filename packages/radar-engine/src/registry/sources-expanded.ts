...
const SOURCES: CompactSource[] = [
  ...
  directory('Grants.gov Arts Funding', 'https://www.grants.gov/search-results.html?group=arts', 'grants-us-national', { id: 'src_grants-us-national_grants_gov_arts_funding_400', disciplines: ['all-disciplines'], opportunityTypes: ['grant'], geography: ['US'], checkIntervalHours: 24, discoveryAdapterId: 'grants-gov-api' }),
  ...
  directory('New York Foundation for the Arts Visual Arts Opportunities', 'https://www.nyfa.org/grant-discipline/visual-arts/', 'visual-open-call', { disciplines: ['visual-arts', 'photography', 'painting', 'sculpture', 'craft'], opportunityTypes: ['grant', 'fellowship', 'award'], geography: ['US', 'global'], checkIntervalHours: 24, discoveryAdapterId: 'nyfa-visual-arts', discoveryLinkLimit: 100 }),
  ...
  directory('ArtConnect Opportunities', 'https://www.artconnect.com/opportunities?sortBy=-deadline', 'grants-international', { disciplines: ['visual-arts', 'film', 'photography', 'design'], opportunityTypes: ['grant', 'residency', 'open-call'], geography: ['global'], checkIntervalHours: 24, discoveryAdapterId: 'artconnect-index', discoveryLinkLimit: 500 }),
  ...
  directory('Sundance Institute Artist Opportunities', 'https://www.sundance.org/deadlines/', 'documentary', { disciplines: ['film', 'documentary', 'screenwriting'], opportunityTypes: ['grant', 'fellowship', 'residency', 'open-call'], geography: ['US', 'global'], checkIntervalHours: 24, discoveryAdapterId: 'sundance-deadlines', discoveryLinkLimit: 100 }),
  directory('Film Independent Programs', 'https://www.filmindependent.org/programs/', 'documentary', { disciplines: ['film', 'documentary', 'screenwriting'], opportunityTypes: ['grant', 'fellowship', 'residency', 'open-call'], geography: ['US', 'global'], checkIntervalHours: 48, discoveryAdapterId: 'film-independent-index', discoveryLinkLimit: 25 }),
  ...
  directory('International Documentary Association Grants Directory', 'https://www.documentary.org/grants-directory', 'documentary', { disciplines: ['documentary', 'film'], opportunityTypes: ['grant', 'fellowship', 'residency', 'open-call'], geography: ['US', 'global'], checkIntervalHours: 168, discoveryAdapterId: 'ida-grants-directory', discoveryLinkLimit: 500 }),
