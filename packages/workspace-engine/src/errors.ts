export type WorkspaceResourceType =
  ...
  | 'opportunity_configuration_version' | 'organization_review_settings' | 'reviewer_group' | 'decision_message_draft' | 'message_delivery_attempt' | 'organization_retention_policy';
