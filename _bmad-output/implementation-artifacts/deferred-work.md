...
## Opportunity fixture parity

- Reconcile hard-coded `north-river-review-call-for-submissions` detail tests with the Railway-backed catalogue. The slug is absent in the live-configured database, while the isolated repository fixture remains green; this Opportunity browse slice does not alter detail fixtures or production records.
