...
- Unauthenticated visitor sees "Log in to submit" (confirmed via accessibility snapshot + screenshot — Fraunces heading and Aubergine accent rendering correctly, i.e. the design pass is visually real, not just class names).
