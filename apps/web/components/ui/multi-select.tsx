...
const MultipleSelector = ({
  ...
  useEffect(() => {
    if (value) {
      // Keep the controlled value synchronized with the premium selector API.
  ...
  useEffect(() => {
    ...
    if (JSON.stringify(newOption) !== JSON.stringify(options)) {
      // Keep grouped options synchronized with the premium selector API.
      // eslint-disable-next-line react-hooks/set-state-in-effect
  ...
  // The registry intentionally provides manual memoization for cmdk's filter contract.
