...
function CodeBlockPane({
  ...
  style,
  highlightLines,
  highlightClassName = "bg-warning/40 dark:bg-warning/40",
                ...
                <code className="block w-max min-w-full">
                  {lines.map((line, i) => {
                    ...
                    return (
                      ...
                      >
                        {showLineNumbers && (
                          <span className="mr-4 w-4 shrink-0 text-right font-mono text-xs leading-relaxed text-muted-foreground/50 select-none">
                            {lineNumber}
                          </span>
                        )}
...
function CodeBlock({
  ...
  React.useEffect(() => {
    if (
      ...
      // Keep the selected tab valid when a multi-file code surface changes.
  ...
  return (
    <div
      ...
      className={cn(
        "overflow-hidden rounded-xl border border-border bg-muted/50 text-sm",
        className,
      )}
      {...props}
    >
      ...
      >
        {isMulti ? (
          ...
          >
            <TabsList
              variant="line"
              className="group-data-horizontal/tabs:h-auto"
            >
