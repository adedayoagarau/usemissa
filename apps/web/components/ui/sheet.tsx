...
} & VariantProps<typeof sheetContentSurfaceVariants>) {
  return (
    <SheetPortal>
      <SheetOverlay />
      <SheetPrimitive.Popup
        ...
        className={cn(
          ...
          sheetContentSurfaceVariants({ surface }),
          className,
        )}
        {...props}
      >
...
const sheetContentSurfaceVariants = cva("", {
  variants: {
    surface: {
...
const sheetHeaderVariants = cva("flex flex-col gap-0.5 p-4", {
  variants: {
    variant: {
      default: "",
