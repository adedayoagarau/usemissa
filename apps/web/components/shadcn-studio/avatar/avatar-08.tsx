...
const AvatarStatusRingDemo = () => {
  return (
    <Avatar className='ring-offset-background ring-2 ring-green-600 ring-offset-2 dark:ring-green-400'>
      ...
      <AvatarBadge className='-right-1.5 -bottom-1.5 bg-success ring-0 group-data-[size=default]/avatar:size-4 dark:bg-success group-data-[size=default]/avatar:[&>svg]:size-3'>
