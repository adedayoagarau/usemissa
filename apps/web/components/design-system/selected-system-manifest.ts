...
export const selectedSystemGroups: readonly SelectedSystemGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        title: 'Profile',
        objective: 'Present a creator-selected portfolio while keeping private preferences and Tracker activity out of the public page.',
        selectedPath: '/design-system/profile-public',
        comparisonPath: '/design-system/profile-portfolio',
        selection: 'Public portfolio · owner editor · sixteen fixtures',
        surface: 'creator',
        customerFacing: true,
      },
      {
