export type SelectedSystemSurface =
  "foundation" | "creator" | "organization" | "public" | "internal";
...
export const selectedSystemGroups: readonly SelectedSystemGroup[] = [
  {
    ...
    description:
      "The navigation and context system every selected page family must inherit.",
    items: [
      {
        title: "Shared shell",
        objective:
          "Keep the canonical Missa wordmark, active product, person, Organization, role, and next destination legible at every width.",
  ...
  },
  {
    ...
    label: "Creator flow",
    description:
      "Discover, decide, prepare, track, and reuse Work without scores or hidden operational language.",
    items: [
      {
        title: "Opportunities browse",
        objective:
          "Support a fast pursue-or-skip decision while keeping work categories and eligibility separate.",
      ...
      },
      {
        ...
        objective:
          "Review the public shell, browse, detail, auth return, and Tracker handoff as one connected path.",
      ...
      },
      {
        ...
        objective:
          "Explain decisive facts, requirements, and the official source without inventing certainty.",
      ...
      },
      {
        title: "Profile",
        objective:
          "Review a public creator page with one Work sample, honest credits, and a clear private boundary.",
      ...
      },
      {
        ...
        objective:
          "Review the public Profile portfolio composition across sample types, owner editing, and edge states.",
        selectedPath: "/design-system/profile-portfolio",
        selection: "Selected composition · review gate",
        surface: "creator",
        customerFacing: true,
      },
      {
        title: "Tracker",
        objective:
          "Keep saved Opportunities, preparation, Submissions, dates, and next actions understandable.",
      ...
      },
      {
        ...
        objective:
          "Place exact deadlines by date while retaining rolling, conflicting, unknown, and response items.",
      ...
      },
      {
        ...
        objective:
          "Retrieve reusable Work across visual, text, sound, performance, and interdisciplinary work.",
      ...
      },
      {
        title: "Inbox",
        objective:
          "Show consequential changes and required actions without becoming a source-health dashboard.",
      ...
      },
      {
        ...
        objective:
          "Keep three bounded utilities evidence-backed, reversible, and honest about unavailable capability.",
  ...
  },
  {
    ...
    description:
      "Operate Opportunities and applications with explicit role, scope, consequence, and recovery.",
    items: [
      {
        title: "Organization chooser and overview",
        objective:
          "Keep Organization and role context stable while routing attention to the exact task.",
      ...
      },
      {
        ...
        objective:
          "Manage an Opportunity inventory and a structured builder without collapsing independent rules.",
      ...
      },
      {
        ...
        objective:
          "Preserve lifecycle state, evidence, rubric context, authority, and irreversible decision boundaries.",
      ...
      },
      {
        ...
        objective:
          "Separate internal notes, external messages, delivery outcomes, and accepted-Work fulfilment.",
        selectedPath: "/design-system/organization-messages-delivery",
        comparisonPath:
          "/design-system/organization-messages-delivery-directions",
      ...
      },
      {
        title: "Insights",
        objective:
          "Answer programme questions with declared denominators, exclusions, and multi-valued work categories.",
      ...
      },
      {
        ...
        objective:
          "Make effective access, role bundle, resource scope, invitation, and seat state distinct.",
        selectedPath: "/design-system/organization-people-permissions",
        comparisonPath:
          "/design-system/organization-people-permissions-directions",
      ...
      },
      {
        ...
        objective:
          "Give each settings domain its own save, authority, risk, and recovery boundary.",
        selectedPath: "/design-system/organization-settings-billing",
        comparisonPath:
          "/design-system/organization-settings-billing-directions",
      ...
      },
      {
        ...
        objective:
          "Lead with active Opportunities and narrow identity evidence rather than institutional vanity metrics.",
      ...
      },
      {
        ...
        objective:
          "Keep public reading, private drafting, Work snapshots, review, payment, submission, and receipt distinct.",
  ...
  },
  {
    ...
    description:
      "Useful public evidence and recoverable entry paths without invented proof or generic marketing theatre.",
    items: [
      {
        title: "Public and acquisition",
        objective:
          "Match each public page to immediate usefulness or editorial evidence while preserving source boundaries.",
      ...
      },
      {
        ...
        objective:
          "Preserve interrupted intent and use progressive onboarding rather than one template for every entry path.",
        selectedPath: "/design-system/auth-onboarding",
        comparisonPath: "/design-system/auth-onboarding-directions",
        selection: "Path-aware synthesis",
        surface: "public",
        customerFacing: true,
      },
    ],
  },
  {
    ...
    description:
      "Deliberate evidence and operations surfaces that keep internal state out of customer pages.",
    items: [
      {
        title: "Reviewer",
        objective:
          "Cross-reference assigned Work against a versioned rubric without leaking identity or unrelated records.",
      ...
      },
      {
        ...
        objective:
          "Join operational state to evidence, bounded action, acknowledgement, and an auditable recovery path.",
...
export const selectedSystemItems: readonly SelectedSystemItem[] =
  selectedSystemGroups.flatMap((group) => group.items);
