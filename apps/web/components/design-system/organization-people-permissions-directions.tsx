    ...
    <main className={styles.page}>
      ...
      <section className={styles.screen} aria-label={`${activeDirection.name} preview`}>
        ...
        <div className={styles.screenBody} id="people">
          ...
          <div className={styles.summaryRow}><SeatSummary used={data.seatUsed} limit={data.seatLimit} /><Card className={styles.conceptCard}><CardContent><ShieldCheck aria-hidden="true" /><div><b>Seat is not permission</b><p>Role bundle and resource scope determine access. Field taxonomy never grants it.</p></div></CardContent></Card></div>
