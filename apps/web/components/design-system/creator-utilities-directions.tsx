...
const fixtures: Record<Surface, Array<{ id: Fixture; label: string }>> = {
  ...
  import: [
    ...
    { id: 'import-taxonomy-review', label: 'Legacy practice review' },
