...
const fixtures: Record<Journey, Array<{ id: Fixture; label: string }>> = {
  ...
  profile: [
    { id: 'profile-start', label: 'Start with broad practices' },
    { id: 'no-practice', label: 'Skip optional practices' },
    { id: 'many-practices', label: 'Many practice interests' },
...
function BrandHeader() {
  return <header className={styles.brandHeader}><a href='#auth-main' className={styles.skipLink}>Skip to form</a><a href='#home' className={styles.wordmark}>Missa</a><a href='#opportunities'>Browse Opportunities</a></header>
}
...
function JourneyRail({ journey }: { journey: Journey }) {
  const steps = journey === 'profile' ? ['Account', 'Practices', 'Interests', 'Privacy', 'Browse'] : journey === 'organization' ? ['Account', 'Organization', 'Role and scope', 'Next task'] : ['Entry task', 'Account', 'Safe return']
