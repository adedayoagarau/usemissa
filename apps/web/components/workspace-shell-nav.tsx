...
export function WorkspaceShellNav({ organizations }: { organizations: Organization[] }) {
  ...
  const primary = [
    { label: 'Workspace', href: linkFor('/workspace', selectedId), path: '/workspace' },
