    ...
    <div className={styles.page}>
      <header className={styles.header}>
        <Link
          ...
          aria-label="Missa opportunities"
        >
          <Image
        ...
        <span className={styles.identity}>
          Adebayo’s private workspace · Design preview
        </span>
      </header>
          ...
          {view === "now" ? (
            <>
              ...
              <p className={styles.intro}>
                Your work is private here. Pick up one application, one
                material, one useful next step.
              </p>
              <div className={styles.todayGrid}>
                <section>
                  <p className={styles.sectionTitle}>
                    Your next move <span>{complete}/3 prepared</span>
                  </p>
                  <article className={styles.priority}>
                    <div className={styles.priorityInner}>
                      ...
                      <p>New York Foundation for the Arts</p>
                      <div
                        className={styles.checklist}
                        aria-label="Application preparation steps"
                      >
                        {[
                          "Review the eligibility details",
                          "Choose a work sample",
                          "Prepare your emergency statement",
                        ].map((task, index) => (
                          <label
                            key={task}
                ...
                <aside className={styles.side}>
                  <section className={styles.mini}>
                    ...
                    <p>
                      Your reusable materials get more useful each time you
                      apply.
                    </p>
                    <div className={styles.numbers}>
                      <div>
                        <strong className="font-heading">3</strong>
                        <span>works</span>
                      </div>
                      <div>
                        <strong className="font-heading">1</strong>
                        <span>book</span>
                      </div>
                    </div>
                  </section>
                  <section className={styles.mini}>
                    <h3>Coming up</h3>
                    <p>
                      <strong>Sep 6</strong> · Grant deadline
                    </p>
                    <p>
                      <strong>Sep 12</strong> · Residency deadline
                    </p>
                  </section>
                </aside>
              </div>
              <section className={styles.upcoming}>
                <p className={styles.sectionTitle}>
                  Keep moving <span>Saved for you</span>
                </p>
                {[
                  ["PH", "Poets House Chapbook Fellowship", "12 days left"],
                  ["CO", "Open Call: Future Forms", "No deadline listed"],
                ].map(([mark, title, detail]) => (
                  <article key={title} className={styles.opportunity}>
                    <span className={styles.monogram}>{mark}</span>
                    <div>
                      <h3>{title}</h3>
                      <p>{detail}</p>
                    </div>
  ...
  const content = {
    applications: [
      ...
      [
        [
          "Rauschenberg Medical Emergency Grants",
          "Preparing · closes tomorrow",
          "Resume",
        ],
        [
          "Poets House Chapbook Fellowship",
          "Saved · closes Sep 12",
          "Start preparing",
        ],
    ...
    materials: [
      ...
      [
        [
          "Three Poems",
          "Writing sample · used in 1 application",
          "Use in application",
        ],
        ["Artist biography", "Short bio · last updated today", "Edit"],
        ["The Years of Blood", "Book · add a link or cover", "View"],
      ],
    ],
    calendar: [
      "Your calendar",
      "Deadlines, preparation dates and expected response windows—clearly marked when a date is only an estimate.",
      [
        ["Sep 6", "Rauschenberg grant deadline", "View application"],
        ["Sep 12", "Poets House fellowship deadline", "Prepare"],
        ["Sep 22", "Expected response · sample call", "About estimated dates"],
      ],
    ],
  } as const;
  const [title, intro, rows] = content[view];
  return (
    <section className={styles.alternate}>
