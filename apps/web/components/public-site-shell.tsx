...
export async function PublicSiteShell({ children, current }: { children: ReactNode; current?: string }) {
    ...
    <div className={styles.site}>
      ...
      <footer className={styles.footer}>
        <div>
          ...
          <p>Creative Opportunities with the source, facts, and limits kept visible.</p>
        </div>
