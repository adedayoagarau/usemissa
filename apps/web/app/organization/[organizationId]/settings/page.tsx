...
const unavailableCopy: Record<Exclude<OrganizationSettingsSection, 'general' | 'structure' | 'billing' | 'review'>, { title: string; description: string; required: string[] }> = {
  ...
  return <main id="organization-main" className={styles.main}>
    ...
    <div className={styles.control}>
      ...
      <section className={styles.panel} aria-labelledby="settings-panel-title">
        ...
        {activeId === 'review' ? <section className={styles.panelBody}><OrganizationReviewSettings organizationId={organizationId} canManage={membership.role === 'admin' || membership.role === 'owner'} /></section> : null}
