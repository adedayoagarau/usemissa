  ...
  return <AdminPageFrame>
    <div className="space-y-8">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div className="rounded-xl border border-border bg-card p-4 shadow-sm"><p className="text-xs font-medium text-muted-foreground">Availability</p><div className="mt-3"><MaturityBadge maturity={area.provenance.maturity} /></div><p className="mt-2 text-xs text-muted-foreground">{area.provenance.freshness}</p></div>
      </div>
