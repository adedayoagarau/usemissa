...
export default async function SubmissionReceiptPage({ params }: { params: Promise<{ submissionId: string }> }) {
  ...
  if (!session) redirect(`/login?next=/my-submissions/${submissionId}`);
