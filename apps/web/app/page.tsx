...
export const metadata = pageMetadata({
  ...
  description: 'Find credible creative Opportunities, open the official source, and keep your decision and deadline together.',
  path: '/',
});
    ...
    <PublicSiteShell current="Home">
      <main id="main-content" className={styles.main}>
        ...
        <section className={styles.hero} aria-labelledby="home-heading">
          <div>
            <p className={styles.eyebrow}>Creative Opportunities, kept understandable</p>
            <h1 id="home-heading">Find the call worth your time.</h1>
            <p>Missa helps you compare the facts, open the official source, save your decision, and keep track of what comes next.</p>
            <div className={styles.heroActions}>
              ...
              <Link href="/methodology" className={styles.secondaryAction}>How Missa handles evidence</Link>
            </div>
          </div>
          <aside className={styles.sourcePromise} aria-labelledby="source-promise-title">
            <ExternalLink aria-hidden="true" />
            <p>Start with the source</p>
            <h2 id="source-promise-title">The official call remains authoritative.</h2>
            <span>Unknown or conflicting facts stay visible. Missa does not turn missing information into reassurance.</span>
