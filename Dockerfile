...
ENV RADAR_ENRICHMENT_BATCH_SIZE=40
ENV RADAR_ENRICHMENT_INTERVAL_MINUTES=3
ENV RADAR_REVIEW_BATCH_SIZE=100
ENV RADAR_REVIEW_INTERVAL_MINUTES=2
ENV RADAR_CONTENT_BATCH_SIZE=100
ENV RADAR_CONTENT_INTERVAL_MINUTES=2
