...
const migrationFiles = [
  ...
  '0037_opportunity_filter_canonicalization.sql',
  '0038_opportunity_search_gin_indexes.sql',
  '0039_gary_profile_issues.sql',
  '0040_organization_media_groups.sql',
  '0041_creator_portfolios.sql',
  '0042_creator_product_states.sql',
  '0042_missa_magazine_rankings.sql',
  '0043_profile_and_opportunity_geography.sql',
  '0044_content_issue_reports.sql',
  ...
  '0052_calendar_linked_deadlines.sql',
  '0053_goal_calendar_dates.sql',
  '0054_calendar_deadline_reconciliation.sql',
  '0055_sms_reminder_readiness.sql',
  ...
  '0058_missa_residency_enrichment.sql',
  '0059_organization_review_settings.sql',
  '0059_publication_editorial_intelligence.sql',
  '0060_aesthetic_dna_and_judge_lineage.sql',
  ...
  '0070_residency_fellowship_intelligence.sql',
  '0071_opportunity_browse_media_index.sql',
